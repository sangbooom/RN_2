      ...
      return (
        <View style={styles.User}>
          ...
          <View style={{ height: 50, flexDirection: "row" }}>
            <View style={{ flex: 1, flexDirection: "row", borderWidth: 0.5, borderLeftWidth: 0, borderRightWidth: 0, borderColor: 'gray', justifyContent: "center" , alignItems: "center" }}>
              <View>
                <Image source={require('../img/list.png')} style={{width:30, height:25}} />
              </View>
              <Text style={{marginLeft: 10}}>내가 쓴 글</Text>
            </View>
            <View style={{ flex: 1, flexDirection: "row", borderWidth: 0.5, borderColor: "gray",justifyContent: "center" , alignItems: "center" }}>
              <View>
                <Image source={require('../img/chat.png')} style={{width:30, height:25}} />
              </View>
              <Text style={{marginLeft: 10}}>댓글 단 글</Text>
            </View>
            <View style={{ flex: 1, flexDirection: "row", borderWidth: 0.5, borderLeftWidth: 0, borderRightWidth: 0, borderColor: 'gray',justifyContent: "center" , alignItems: "center" }}>
              <View>
                <Image  source={require('../img/star.png')} style={{width:30, height:25}} />
              </View>
              <Text style={{marginLeft: 10}}>스크랩</Text>
            </View>
          </View>
        </View>
      );
